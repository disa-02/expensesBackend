...
@Service
public class SavingSpaceOperationService {

    @Autowired
    SavingSpaceRepository workSpaceRepository;
    ...
    public OperationDto addOperation(Integer userId, Integer spaceId, OperationAddDto operationDto) {
        ...
        savingSpace.getOperations().add(operation);
    ...
    private Operation findOperation(SavingSpace workSpace, Integer operationId){
    ...
    private AccountBalance findAccountBalance(SavingSpace workSpace, Integer accountId){
    ...
    //     SavingSpace workSpace = (SavingSpace)operation.getSpace();
    //     if(workSpace != null){
